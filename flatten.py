...
# 修改只需要以下路径，更换为最新日期所对应的文件夹即可
SNAPSHOT_DIR = '/path/to/downloaded_data'
CSV_DIR = '/path/to/download/csv-files'

'''
解压出来会出现以下压缩文件：
authors_counts_by_year.csv.gz                topics.csv.gz                   works_mesh.csv.gz
authors.csv.gz                               works_authorships.csv.gz        works_open_access.csv.gz
authors_ids.csv.gz                           works_best_oa_locations.csv.gz  works_primary_locations.csv.gz
institutions_associated_institutions.csv.gz  works_biblio.csv.gz             works_referenced_works.csv.gz
institutions_counts_by_year.csv.gz           works_concepts.csv.gz           works_related_works.csv.gz
institutions.csv.gz                          works.csv.gz                    works_topics.csv.gz
institutions_geo.csv.gz                      works_ids.csv.gz
institutions_ids.csv.gz                      works_locations.csv.gz

只需要保留以下文件：

# 关系表文�?
institutions.csv.gz      institutions_geo.csv.gz
topics.csv.gz
authors.csv.gz
works.csv.gz             works_topics.csv.gz          works_authorships.csv.gz    works_referenced_works.csv.gz   works_biblio.csv.gz

# 以下模型文件由上述关系表文件生成
# �?顶点表文�?
authors_vertices.csv(顶点�?、topics_vertices.csv(顶点�?、works_vertices.csv(顶点�?
通过authors.csv、topics.csv、works.csv文件生成     参考代�?generate_vertices.py

# �?边表文件
(1)authors_authors_edges.csv(边表)通过works.csv和works_authorships.csv文件文件生成,   参考代�?authors_Cooperations.py
(2)works_authorships_edges.csv(边表)和works_topics_edges.csv(边表)和works_referenced_works_edges.csv(边表),authors_institutions_edges.csv(边表,但这个边表不需要了)
通过works_authorships.csv�?works_topics.csv、works_referenced_works.csv文件生成   参考代�?generate_edges.py

# 文档表文�?
works_document.csv(文档�?通过works.csv、works_biblio.csv、works_authorships.csv文件生成,   参考代�?generate_documents.py

# 向量表文�?
(1)works_vector.csv(向量�?通过works.csv文件生成   参考代�?generate_vectors_log.py(因为生成时间�?所以需要记录日�?
(2)topics_vector.csv(向量�?通过topics.csv文件生成   参考代�?topices_vector.py
'''
